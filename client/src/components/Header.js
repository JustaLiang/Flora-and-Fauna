    ...
    return (
        <AppBar className={classes.appBar}>
            <Toolbar >
                ...
                <Button component={Link} variant='outlined' to="/Playground" className={clsx(classes.greenButton, {
                            [classes.redButton]: props.checked
                        })} style={{textTransform: 'none',marginRight:20,fontWeight:'bold',fontSize:'1rem'}}>
                          Playground
                        </Button>
                <FormControlLabel
                    control={<Switch />}
                    label={<Typography variant='body' className={clsx(classes.switch_green, {
